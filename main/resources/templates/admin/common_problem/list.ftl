                  ...
                  <div class="input-group">
                    <div class="input-group-btn">
                      <button class="btn btn-default dropdown-toggle" id="search-btn" data-toggle="dropdown" type="button" aria-haspopup="true" aria-expanded="false">
                          问题名称 <span class="caret"></span>
                      </button>
                      <ul class="dropdown-menu">
                        <li> <a tabindex="-1" href="javascript:void(0)" data-field="title">问题名称</a> </li>
                      </ul>
                    </div>
                    <input type="text" class="form-control" value="${name!""}" name="name" placeholder="请输入问题名称">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                     <#if pageBean.content?size gt 0>
                      <#list pageBean.content as problem>
                      <tr>
                        <td style="vertical-align:middle;">
                          <label class="lyear-checkbox checkbox-primary">
                            <input type="checkbox" name="ids[]" value="${problem.id}"><span></span>
                          </label>
                        </td>
                        <td style="vertical-align:middle;" >${problem.name}</td>
                          <td style="vertical-align:middle;" >${problem.answer}</td>
                        <td style="vertical-align:middle;" ><font class="text-success">${problem.createTime}</font></td>
                      </tr>
                    </#list>
                    <#else>
