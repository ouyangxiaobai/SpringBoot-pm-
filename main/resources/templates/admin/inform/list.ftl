...
<title>${siteName!""}|新闻通知管理-${title!""}</title>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="vertical-align:middle;">${item.province}${item.city}${item.county}</td>
                        <td style="vertical-align:middle;" style="vertical-align:middle;"><font class="text-success">
                            ${item.createTime}</font></td>
                          <td>
                              <a class="btn btn-success m-r-5 view-content" href="javascript:void(0);"><i
                                      class="mdi mdi-check"></i>查看内容</a>
                          </td>
                          <td style="vertical-align:middle; display: none;" class="news-content" >${item.content}</td>
                      </tr>
                    </#list>
                    <#else>
