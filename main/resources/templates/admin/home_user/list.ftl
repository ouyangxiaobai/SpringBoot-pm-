                ...
                <div class="table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <#list pageBean.content as homeUser>
                      <tr>
                        <td style="vertical-align:middle;">
                          <label class="lyear-checkbox checkbox-primary">
                            <input type="checkbox" name="ids[]" value="${homeUser.id}"><span></span>
                          </label>
                        </td>
                        <td style="vertical-align:middle;">${homeUser.id}</td>
                        <td style="vertical-align:middle;">${homeUser.username}</td>
                        <td style="vertical-align:middle;">
                        ...
                        <td style="vertical-align:middle;">${homeUser.mobile}</td>
                        <td style="vertical-align:middle;">${homeUser.email}</td>
                      </tr>
                    </#list>
                    <#else>
...
function edit(url){
	...
	window.location.href = url + '?homeUserId=' + $("input[type='checkbox']:checked").val();
}
