            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="vertical-align:middle;">${with.homeUser.name!with.homeUser.username}</td>
                        <td style="vertical-align:middle;">${with.homeUser.email}</td>
                        <td style="vertical-align:middle;">${with.homeUser.mobile}</td>
                ...
                <ul class="pagination ">
                  ...
                  <#else>
                  <li><a href="wr_list?currentPage=1">«</a></li>
                  </#if>
                  <#list pageBean.currentShowPage as showPage>
                  <#if pageBean.currentPage == showPage>
                  <li class="active"><span>${showPage}</span></li>
                  <#else>
                  <li><a href="wr_list?currentPage=${showPage}">${showPage}</a></li>
                  </#if>
                  </#list>
                  <#if pageBean.currentPage == pageBean.totalPage>
                  <li class="disabled"><span>»</span></li>
                  <#else>
                  <li><a href="wr_list?currentPage=${pageBean.totalPage}">»</a></li>
                  </#if>
