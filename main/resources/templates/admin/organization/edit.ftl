    ...
    <main class="lyear-layout-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header"><h4>编辑机构</h4></div>
              <div class="card-body">
                <form  id="user-add-form" class="row">
                  ...
                  <div class="input-group" style="margin-top:15px;margin-bottom:15px;padding-left:25px;">
                    ...
                    <input type="radio" name="auditStatus" value="3" <#if item.auditStatus == 3> checked </#if>>
                    <span>正常</span>
                    <label class="lyear-radio radio-inline radio-primary">
                    <input type="radio" name="auditStatus" value="4" <#if item.auditStatus == 4> checked </#if>>
                    <span>冻结</span>
                  </label>
                  </div>
