        ...
        <main class="lyear-layout-content">
            ...
            <div class="container-fluid">
                ...
                <#include "../common/third-menu.ftl"/>
                      ...
                      <#list pageBean.content as newsType>
                      <tr>
                          <td style="vertical-align:middle;">
                              <label class="lyear-checkbox checkbox-primary">
                                  <input type="checkbox" name="ids[]" value="${newsType.id}"><span></span>
                              </label>
                          </td>
                          <td style="vertical-align:middle;">${newsType.name}</td>
                          <td style="vertical-align:middle;" style="vertical-align:middle;"><font
                                  class="text-success">${newsType.createTime}</font></td>

                      </tr>
                      </#list>
                      <#else>
                    <tr align="center">
                        <td colspan="3">这里空空如也！</td>
                    </tr>
                      </#if>
                                        </tbody>
                                    </table>
